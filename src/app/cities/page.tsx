...
import { CityMap, MoroccoOverviewMap } from '@/components/city-map';
...
const MAJOR_CITIES = [
  ...
  { name: 'Fes', slug: 'fes', description: 'Ancient medina and traditional crafts' },
  { name: 'Agadir', slug: 'agadir', description: 'Coastal art and modern development' },
  { name: 'Ouarzazate', slug: 'ouarzazate', description: 'Gateway to the Sahara' },
];
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6]">
      ...
      <section className="relative h-[70vh] md:h-[80vh] overflow-hidden">
        {/* Map background */}
        <MoroccoOverviewMap className="absolute inset-0" />
            ...
            {MAJOR_CITIES.map((city, index) => (
              ...
              >
                <div className={`relative ${
                  ...
                  {/* Mapbox Map */}
                  <CityMap city={city.slug} className="absolute inset-0" />
